...
const CommunityMansion = () => {
  ...
  const loadMembers = async () => {
    try {
      ...
      // Demo data
      setMembers([
        { id: 1, name: 'Alexandra Sterling', email: 'alex@mansion.com', role: 'founder', room: 'penthouse' },
        { id: 2, name: 'Marcus Thompson', email: 'marcus@mansion.com', role: 'moderator', room: 'library' },
        { id: 3, name: 'Sofia Rodriguez', email: 'sofia@mansion.com', role: 'resident', room: 'garden' },
        { id: 4, name: 'James Chen', email: 'james@mansion.com', role: 'resident', room: 'workshop' }
      ]);
    }
  };
      ...
      <div className="container mx-auto px-4 py-8 relative z-10">
        ...
        <div className="text-center mt-12 text-amber-700">
          ...
          <p className="text-sm mt-2 opacity-75">
            Backend: <code className="bg-amber-200/50 px-2 py-1 rounded">{API_BASE}</code>
          </p>
        </div>
      </div>
    </div>
